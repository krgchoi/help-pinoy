                ...
                <tbody>
                    <?php if (!empty($donations)): ?>
                        <?php foreach ($donations as $donation): ?>
                            <tr data-status="<?php echo htmlspecialchars($donation['payment_status']); ?>">
                                <td data-label="Donation ID">
                                    <div class="fw-bold"><?php echo htmlspecialchars($donation['xendit_payment_id']); ?></div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><i class="bi bi-info-circle me-2"></i>Donation Details</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="donation-detail">
                                        <strong>Donation ID:</strong> <?php echo htmlspecialchars($donation['donation_id']); ?>
                                    </div>
                                    <div class="donation-detail">
                                        <strong>Donor Name:</strong> <?php echo htmlspecialchars($donation['full_name']); ?>
                                    </div>
                                    <div class="donation-detail">
                                        <strong>Email:</strong> <?php echo htmlspecialchars($donation['email']); ?>
                                    </div>
                                    <div class="donation-detail">
                                        <strong>Contact:</strong> <?php echo htmlspecialchars($donation['contact_number']); ?>
                                    </div>
                                    <div class="donation-detail">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="donation-detail">
                                        <strong>Amount:</strong> ₱ <?php echo number_format($donation['amount'], 2); ?>
                                    </div>
                                    <div class="donation-detail">
                                    ...
                                    <div class="donation-detail">
                                        <strong>Payment Method:</strong> <?php echo $donation['payment_method'] ?: 'N/A'; ?>
                                    </div>
                                    <div class="donation-detail">
                                    ...
                                    <div class="donation-detail">
                                        ...
                                        <?php if ($donation['receipt_url']): ?>
                                            <a href="<?php echo htmlspecialchars($donation['receipt_url']); ?>" target="_blank" class="btn btn-outline-primary btn-sm ms-2">
                                                <i class="bi bi-receipt me-1"></i> View Receipt
                                            </a>
                                        <?php else: ?> N/A <?php endif; ?>
                                    </div>
                                    <div class="donation-detail">
                                        <strong>Date Donated:</strong> <?php echo date('F j, Y h:i A', strtotime($donation['donation_date'])); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
